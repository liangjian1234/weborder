            ...
            function setListData(curPageData, isAppend) {
                ...
                if(curPageData.length<1){
                    ...
                    for (var i = 0; i < curPageData.length; i++) {
                        ...
                        if (newObj1.avatar != null && newObj1.avatar != '') {
                            var avatar = newObj1.avatar;
                        }else{
                            var avatar = 'data:image/png;base64,';
                        }
                        var str = '<div class="weui-cell__hd">'+
                            '<img src="'+avatar+'" alt="" style="width:65px;margin-right:5px;display:block"></div>\n'+
